...
type PlanCharacteristics struct {
	...
	GeographyType                        GeoType         `json:"geographyType" db:"geography_type"`
	GeographyTypeOther                   *string         `json:"geographyTypeOther" db:"geography_type_other"`
	GeographiesAppliedTo                 GeoApp          `json:"geographiesAppliedTo" db:"geographies_applied_to"`
	...
	AgreementType                        AgrType         `json:"agreementType" db:"agreement_type"`
	...
	AutthorityToTest                     AuthorityToTest `json:"autthorityToTest" db:"autthority_to_test"`
...
const (
	GeoState  GeoType = "State"
	GeoRegion GeoType = "Region"
	GeoOther  GeoType = "Other"
)

type GeoApp string

const (
	GeoAppPart  GeoApp = "Participants"
	GeoAppProv  GeoApp = "Providers"
	GeoAppBene  GeoApp = "Beneficiaries"
	GeoAppOther GeoApp = "Other"
)

type AgrType string

const (
	AgrTypePart  AgrType = "Participation Agreement"
	AgrTypeCoOp  AgrType = "Co-Operative Agreement/Grant"
	AgrTypeOther AgrType = "Other"
	AgrTypeTBD   AgrType = "TBD"
)

type AuthorityToTest string

const (
	Auth3021     AuthorityToTest = "3021 (ACA)"
	AuthCongress AuthorityToTest = "Congressionally Mandated"
	Auth1833     AuthorityToTest = "Section 1833(e) (Part B services) of the Social Security Act"
	AuthTBD      AuthorityToTest = "TBD"
	AuthOther    AuthorityToTest = "Other"
)

type WaiverType string

const (
	WaiverFraud    WaiverType = "Fraud and Abuse"
	WaiverProgPay  WaiverType = "Program/payment"
	WaiverMedicaid WaiverType = "Medicaid"
	WaiverTBD      WaiverType = "TBD"
)
